...
import me.aichina.board.Piece;
import me.aichina.board.PieceType;
import me.aichina.game.Move;
import me.aichina.game.Player;

/**
 * 棋谱，用于记录一局对弈过程，可将对弈过程保存为文本文件，棋谱格式以2018年《中国大学生计算机博弈大赛棋谱标准说明书》为准<br>
 * 相关链接：http://computergames.caai.cn/
 * 
 * @author 陆梦轩
 *
 */
