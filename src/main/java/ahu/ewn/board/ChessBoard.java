...
public class ChessBoard {
    ...
    public Byte goWin(PieceType player, byte dice) {
        List<Byte> bs = getPiecesByDice(player, dice);
    ...
    public Byte method(PieceType player, byte dice) {
        List<Byte> bs = getPiecesByDice(player, dice);
        if (player == PieceType.BLUE) {
            byte b = getPieceByPoint(1, 1);
            String id = Piece.toString(b);
            ...
            if (chars[0] == 'B') {
                ...
                System.out.println(player+"不能直接赢 红子"+id);
                return null;
            }
        }
        ...
        if (player == PieceType.RED) {
            ...
            if (chars[0] == 'R') {
                ...
                if (b1) {
                    System.out.println(player + "直接赢了");
                    return b;
                }
            } else {
                System.out.println(player+"不能直接赢 蓝子"+id);
...
//        }
    ...
    public byte getPieceByPoint(Point point) {
    ...
    public Point getPointById(byte piece) {
